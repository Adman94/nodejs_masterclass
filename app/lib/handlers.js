...
handlers._users.post = function(data, callback) {
    ...
    const password = typeof(data.payload.password) == 'string' && data.payload.phone.trim().length > 0 ? data.payload.password.trim() : 
    false;
...
//  @TODO Only let an authenticated user uodate their won object. Don't let them update anyone else's.
